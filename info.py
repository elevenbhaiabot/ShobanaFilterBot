...
BOT_TOKEN = environ.get('BOT_TOKEN', '8335988150:AAGbJQqaaNNCqhFnAzoEayDD3KEEmPfhT1Y')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5361557359']
...
FILE_CHANNELS = [int(ch) for ch in environ.get('FILE_CHANNELS', '--1003895247843').split()]
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003867387938'))
